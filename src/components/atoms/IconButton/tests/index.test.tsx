...
describe('IconButton component', () => {
  ...
  it('should render icon button correctly', () => {
    ...
    expect(button).toHaveClass(
      'rounded-full border border-grey-medium font-exo leading-5 tracking-[.07em] text-center text-xl py-4 px-4'
    )
  })
  ...
  it('should render small size icon button', () => {
    ...
    expect(button).toHaveClass('text-base w-[43px] h-[43px]')
  })
  ...
  it('should render medium size icon button', () => {
    ...
    expect(button).toHaveClass('text-xl py-4 px-4')
  })
})
